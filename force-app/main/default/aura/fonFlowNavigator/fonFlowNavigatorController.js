      ...
      switch (destinationType) {
        ...
        case 'record':
          ...
          if (
            ...
            throw new Error(
              'Error due to either 1) Missing RecordId. Since you have DestinationType set to record, you need to pass in a RecordId. If you want to create a new record, use a DestinationType of object instead and a DestinationAction of new or 2) You need to provide a Destination Action of edit, view or clone'
            );
          }
          break;
